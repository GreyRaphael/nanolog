...
inline void initialize(std::string dir, std::string name, uint32_t roll_mb, uint32_t max_files, uint32_t queue_mb = 16) {
    g_thread_queue_size.store(queue_mb * 1024 * 1024, std::memory_order_seq_cst);
...
inline void initialize(uint32_t queue_mb = 16) {
    g_thread_queue_size.store(queue_mb * 1024 * 1024, std::memory_order_seq_cst);
